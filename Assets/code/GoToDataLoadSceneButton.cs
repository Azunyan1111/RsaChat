...
public class GoToDataLoadSceneButton : MonoBehaviour {
	...
	public void OnClick() {
		...
		{
			StartCoroutine(signup(GameData.UserData.url + "signup", username, password, "key", random_string));
			/*
		...
		{
			StartCoroutine(signup(GameData.UserData.url + "signin", username, password, "key", random_string));			
		}
